...
from ultralytics.nn.tasks import ClassificationModel, DetectionModel, OBBModel, CornersModel, PoseModel, SegmentationModel, WorldModel
...
class YOLO(Model):
    ...
    def task_map(self):
        ...
        return {
            ...
            "corners": {
                "model": CornersModel,
                "trainer": yolo.corners.CornersTrainer,
                "validator": yolo.corners.CornersValidator,
                "predictor": yolo.corners.CornersPredictor,
            }
        }
